...
<body>
                ...
                <div class="tabs-container">
                    <div class="tabs-block">
                        <div id="tabs-section" class="tabs">
                            <ul class="tab-head">
                                <li>
                                    <a href="#tab-1" class="tab-link active"> <span class="material-icons tab-icon"></span> <span class="tab-label"><i class="fa fa-home"></i> Dashboard</span></a>
                                </li>
                                <li>
                                    <a href="#tab-2" class="tab-link"> <span class="material-icons tab-icon"></span> <span class="tab-label"><i class="fa fa-user"></i> Profile</span></a>
                                </li>
                                <li>
                                    <a href="#tab-3" class="tab-link"> <span class="material-icons tab-icon"></span>
                                        <span class="tab-label"><i class="fa-solid fa-bag-shopping"></i> Orders</span></a>
                                </li>
                                <li>
                                    <a href="#tab-4" class="tab-link"> <span class="material-icons tab-icon"></span> <span class="tab-label"><i class="fa-solid fa-lock"></i> Order Tracking</span></a>
                                </li>
                                <li>
                                    <a href="#tab-5" class="tab-link"> <span class="material-icons tab-icon"></span> <span class="tab-label"><i class="fa-solid fa-cart-shopping"></i> Whishlist</span></a>
                                </li>
                                <li>
                                    <a href="#tab-6" class="tab-link"> <span class="material-icons tab-icon"></span> <span class="tab-label"><i class="fa-solid fa-message"></i> Helpdesk</span></a>
                                </li>
                                <li>
                                    <a href="#tab-7" class="tab-link"> <span class="material-icons tab-icon"></span> <span class="tab-label"><i class="fa-solid fa-square-check"></i> Change Password</span></a>
                                </li>
                                <li>
                                    <a href="index.php" class="tab-link"><span class="material-icons tab-icon"></span> <span class="tab-label"><i class="fa-solid fa-square-check"></i> Logout</span></a>
                                </li>
                                <li>
                                    <a href="#tab-8" class="tab-link"> <span class="material-icons tab-icon"></span> <span class="tab-label"><i class="fa-solid fa-square-check"></i> Saved Cards</span></a>
                                </li>
                                <li>
                                    <a href="#tab-9" class="tab-link"> <span class="material-icons tab-icon"></span> <span class="tab-label"><i class="fa-solid fa-square-check"></i> Wallet</span></a>
                                </li>
                            </ul>
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="holder">
                                                        <ul id="ticker01">
                                                            <li><span> <i class="fa-regular fa-hand-point-right"></i></span><a href="#">The first thing that most Javascript programmers</a></li>
                                                            <li><span> <i class="fa-regular fa-hand-point-right"></i></span><a href="#">End up doing is adding some code</a></li>
                                                            <li><span> <i class="fa-regular fa-hand-point-right"></i></span><a href="#">The code that you want to run</a></li>
                                                            <li><span> <i class="fa-regular fa-hand-point-right"></i></span><a href="#">Inside of which is the code that you want to run</a></li>
                                                            <li><span> <i class="fa-regular fa-hand-point-right"></i></span><a href="#">Right when the page is loaded</a></li>
                                                            <li><span> <i class="fa-regular fa-hand-point-right"></i></span><a href="#">Problematically, however, the Javascript code</a></li>
                                                            <li><span> <i class="fa-regular fa-hand-point-right"></i></span><a href="#">The first thing that most Javascript programmers</a></li>
                                                            <li><span> <i class="fa-regular fa-hand-point-right"></i></span><a href="#">End up doing is adding some code</a></li>
                                                            <li><span> <i class="fa-regular fa-hand-point-right"></i></span><a href="#">The code that you want to run</a></li>
                                                            <li><span> <i class="fa-regular fa-hand-point-right"></i></span><a href="#">Inside of which is the code that you want to run</a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <table>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="center"><i class="fa fa-user"></i></td>
                                                        <td>
                                                            <p>Your Name</p>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td class="center"><i class="fa fa-phone"></i></td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td class="center"><i class="fa-solid fa-envelope"></i></td>
                                                        <td>
                                                            <p>Email Id</p>
                                                        </td>
                                                        <td>
                                                            <p>kawaljassal2@gmail.com</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="center"><i class="fa fa-home"></i></td>
                                                        <td>
                                                            <p>Address 1</p>
                                                        </td>
                                                        <td>
                                                            <p>A-10-C Shivangi Kunj Opp BG-1 Paschim Vihar New Delhi - 110063</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="center"><i class="fa fa-home"></i></td>
                                                    ...
                                                    <tr>
                                                        <td class="center"><i class="fa-solid fa-calendar-days"></i></td>
                                                        <td>
                                                            <p>Date Of Birth</p>
                                                        </td>
                                                        <td>
                                            ...
                                            <div class="center" style="margin-top: 20px;">
                                                <a href="#" id="click-form" class="btn btn-style1">Edit Profile</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form action="">
                                                ...
                                                <div class="col-full">
                                                    <div class="input-group input-group-icon">
                                                        <input type="text" placeholder="Enter Your Alternative Contact Number" required />
                                                        <div class="input-icon"><i class="fa fa-phone"></i></div>
                                                    </div>
                                                </div>
                                                <div class="col-full">
                                                ...
                                                <div class="col-half">
                                                    ...
                                                    <div class="input-group input-group-icon">
                                                        ...
                                                        <input type="date" name="" id="" placeholder="Enter Your Date Of Birth">
                                                        <div class="input-icon"><i class="fa-solid fa-calendar-days"></i></div>
                                                    </div>
                                                </div>
                                                <div class="col-half">
                                                    <lable>Enter Your Anniversary Date</lable>
                                                    <div class="input-group input-group-icon">
                                                        <!-- <input type="text" placeholder="State" required /> -->
                                                ...
                                                <div class="center" style="margin-top: 20px;">
                                                <a href="#" class="btn btn-style1">Save Details</a>
                            ...
                            <section id="tab-3" class="tab-body entry-content">
                                ...
                                <div class="my-order">
                                    <div class="my-order-detalis">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="my-order-detalis-box">
                                                        <div class="order-img">
                                                            <img src="image/product-img/eggplant.jpg" alt="">
                                                        </div>
                                                            ...
                                                            <table>
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td>Date</td>
                                                                        <td>:</td>
                                                                        <td class="order-id">20 June 2023</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Amount</td>
                                                                        <td>:</td>
                                                                        <td class="order-id">₹ 2,000</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Status</td>
                                                                        <td>:</td>
                                                                        <td class="order-id">Active</td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                                        <div class="order-btn">
                                                            <a href="#popup1" class="btn btn-style2">View Details</a>
                                                            <div id="popup1" class="overlay1">
                                                                <div class="popup">
                                                                    <a class="close" href="#"><i class="fa-sharp fa-solid fa-xmark"></i></a>
                                                                    <div class="content">
                                                                        <h5>Order Id: 12345678 <span class="order-active">Active</span></h5>
                                                                        <table>
                                                                            <thead>
                                                                                <tr>
                                                                                    <th class="main-color">S.No</th>
                                                                                    <th class="main-color">Item Name</th>
                                                                                    <th class="main-color">Item Code</th>
                                                                                    <th class="main-color">Quantity</th>
                                                                                    <th class="main-color">Product Cost</th>
                                                                                </tr>
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td>
                                                                            ...
                                                                            <tfoot>
                                                                                ...
                                                                                <tr>
                                                                                    <td colspan="4" class="main-color"><strong>Tax</strong></td>
                                                                                    <td style="text-align:right;"><strong> ₹ 10,000.00</strong></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td colspan="4" class="main-color"><strong>Delivery Charges</strong></td>
                                                                                    <td style="text-align:right;"><strong> ₹ 100.00</strong></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td colspan="4" class="main-color"><strong>Tota</strong></td>
                                                                                    <td style="text-align:right;"><strong> ₹ 10,000.00</strong></td>
                                                                                </tr>
                                                                            </tfoot>
                                                                        </table>
                                                            ...
                                                            <table>
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td>Status</td>
                                                                        <td>:</td>
                                                                        <td class="order-id">Delivered</td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                                        <div class="order-btn">
                                                            <a href="#popup2" class="btn btn-style2">View Details</a>
                                                            <div id="popup2" class="overlay1">
                                                                <div class="popup">
                                                                    <a class="close" href="#"><i class="fa-sharp fa-solid fa-xmark"></i></a>
                                                                    <div class="content">
                                                                        <h5>Order Id: 12345678 <span class="order-delivered">Delivered</span></h5>
                                                                        <table>
                                                                            <thead>
                                                                                <tr>
                                                                                    <th class="main-color">S.No</th>
                                                            ...
                                                            <table>
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td>Status</td>
                                                                        <td>:</td>
                                                                        <td class="order-id">Return</td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                                        <div class="order-btn">
                                                            <a href="#popup3" class="btn btn-style2">View Details</a>
                                                            <div id="popup3" class="overlay1">
                                                                <div class="popup">
                                                                    <a class="close" href="#"><i class="fa-sharp fa-solid fa-xmark"></i></a>
                                                                    <div class="content">
                                                                        <h5>Order Id: 12345678 <span class="order-return">Return</span></h5>
                                                                        <table>
                                                                            <thead>
                                                                                <tr>
                                                                                    <th class="main-color">S.No</th>
                                                            ...
                                                            <table>
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td>Status</td>
                                                                        <td>:</td>
                                                                        <td class="order-id">Refund</td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                                        <div class="order-btn">
                                                            <a href="#popup4" class="btn btn-style2">View Details</a>
                                                            <div id="popup4" class="overlay1">
                                                                <div class="popup">
                                                                    <a class="close" href="#"><i class="fa-sharp fa-solid fa-xmark"></i></a>
                                                                    <div class="content">
                                                                        <h5>Order Id: 12345678 <span class="order-refund">Refund</span></h5>
                                                                        <table>
                                                                            <thead>
                                                                                <tr>
                                                                                    <th class="main-color">S.No</th>
                            ...
                            <section id="tab-4" class="tab-body entry-content">
                                ...
                                <div class="container">
                                    <form action="">
                                        <div class="col-full">
                                            <div class="input-group input-group-icon">
                                                <input type="text" placeholder="Enter Your Order Id" required />
                                                <div class="input-icon"><i class="fa-solid fa-user"></i></div>
                                            </div>
                                        </div>
                                        <div class="center">
                                            <a href="#" class="btn btn-style1">Track Now</a>
                                        </div>
                                    </form>
                                    <br>
                                    <br>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td width="15%" class="center">₹ 1,200.00</td>
                                                                <td width="20%" class="center"><span class="in-stock-box">In Stock</span></td>
                                                                <td width="20%" class="text-center center"><a href="#" class="trash-icon"><i class="fa-solid fa-cart-shopping"></i></a> <a href="#" class="trash-icon"><i class="far fa-trash-alt"></i></a></td>
                                                            </tr>
                                                            <tr>
                                                                <td width="45%" class="center">
                                                                    <div class="display-flex align-center">
                            ...
                            <section id="tab-6" class="tab-body entry-content">
                                                    ...
                                                    <form action="">
                                                        <div class="col-half">
                                                            <div class="input-group input-group-icon">
                                                                ...
                                                                <div class="input-icon"><i class="fa-solid fa-cart-shopping"></i></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-half">
                                                            <div class="input-group input-group-icon">
                                                                <input type="file" placeholder="Upload Your Document" required />
                                                                <div class="input-icon"><i class="fa-solid fa-file-lines"></i></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-full">
                                                            <div class="input-group input-group-icon">
                                                                <input type="text" placeholder="Enter Your Message" required />
                                                                <div class="input-icon"><i class="fa-solid fa-comments"></i></div>
                                                            </div>
                                                        </div>
                                ...
                                <h4>Previous Enquiry</h4>
                                <table>
                                    <thead>
                                        <tr>
                                            <th class="main-color" style="text-align: left;">S.No.</th>
                                            <th class="main-color" style="text-align: left;">Ticket No.</th>
                                            <th class="main-color" style="text-align: left;">Your Message</th>
                                            <th class="main-color" style="text-align: left;">Documents</th>
                                            <th class="main-color" style="text-align: left;">Status</th>
                                        </tr>
                                    <tbody>
                                        <tr>
                                            <td class="main-color">1.</td>
                                            <td>10001</td>
                                            <td>Wrong Products</td>
                                            <td>img.jpg</td>
                                            <td>OPEN</td>
                                        </tr>
                                        <tr>
                                            <td class="main-color">2.</td>
                                            <td>10002</td>
                                            <td>Wrong Products</td>
                                            <td>img.jpg</td>
                                            <td>OPEN</td>
                    ...
                    C707.1,246.4,704.4,249.1,701.1,249.1z" />
                                            ...
                                            <div class="center">
                                                <a href="#popup7" class="btn btn-style1">Delete Card</a>
                                                <div id="popup7" class="overlay1" style="z-index: 999999;">
                                                    <div class="popup">
                                                        <a class="close" href="#"><i class="fa-sharp fa-solid fa-xmark"></i></a>
                                                        <div class="content center">
                                                            <h5>Do You Want To Delete This Card ?</h5>
                                                            <a href="" class="btn btn-style1">Yes</a>
                                                            <a href="" class="btn btn-style1">No</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    C707.1,246.4,704.4,249.1,701.1,249.1z" />
                                            ...
                                            <div class="center">
                                                <a href="product.php" class="btn btn-style1">Delete Card</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    C707.1,246.4,704.4,249.1,701.1,249.1z" />
                            ...
                            <section id="tab-9" class="tab-body entry-content">
                                ...
                                <div class="wallet-icon">
                                    <img src="image/wallet-icon.jpg" alt="">
                                </div>
                                <table>
                                    <thead>
                                        <tr>
                                            <th class="main-color" style="text-align: left;">S.No.</th>
                                            <th class="main-color" style="text-align: left;">Amount</th>
                                            <th class="main-color" style="text-align: left;">Txn Type</th>
                                            <th class="main-color" style="text-align: left;">Txn Date</th>
                                            <th class="main-color" style="text-align: left;">Txn Mode</th>
                                            <th class="main-color" style="text-align: left;">Wallet Balance</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                            ...
                            <div class="col-md-3">
                                <div class="product-box">
                                    ...
                                    <div class="product-box-content">
                                        ...
                                        <p>Blood orange with kale</p>
                                        <div class="rate">$16.00 <span class="discount">$20.00</span></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
    ...
    <script>
        ...
        let clickOpen = document.getElementById("editform");
